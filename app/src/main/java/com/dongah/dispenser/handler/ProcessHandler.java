...
import com.dongah.dispenser.websocket.ocpp.core.GetConfigurationConfirmation;
import com.dongah.dispenser.websocket.ocpp.core.KeyValueType;
...
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.AnnounceConfirmation;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.GetPriceData;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.GetPriceRequest;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.PartialCancelData;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.PartialCancelRequest;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.PayInfoData;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.PayInfoRequest;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.ResultPriceData;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.ResultPriceRequest;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.SmsMessageData;
import com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah.SmsMessageRequest;
        ...
        switch (msg.what) {
            ...
            case GlobalVariables.MESSAGE_HANDLER_GET_PRICE:
                try {
                    ...
                    getPriceRequest.setVendorId(chargerConfiguration.getChargePointVendor());
...
//                        }
            ...
            case GlobalVariables.MESSAGE_HANDLER_RESULT_PRICE:
                try {
                    ...
                    resultPriceRequest.setVendorId(chargerConfiguration.getChargePointVendor());
            ...
            case GlobalVariables.MESSAGE_HANDLER_SMS_MESSAGE:
                try {
                    ...
                    smsMessageRequest.setVendorId(chargerConfiguration.getChargePointVendor());
