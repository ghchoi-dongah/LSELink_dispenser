...
public class UnitPriceConfirm implements Validatable {

    private static final Logger logger = LoggerFactory.getLogger(UnitPriceConfirm.class);

    private Status status;

    private String data;

    public UnitPriceConfirm() {}
    ...
    public boolean equals(Object o) {
        ...
        UnitPriceConfirm that = (UnitPriceConfirm) o;
