...
public class UserSetSocConfirm implements Validatable {

    private static final Logger logger = LoggerFactory.getLogger(UserSetSocConfirm.class);
    ...
    public boolean equals(Object o) {
        ...
        UserSetSocConfirm that = (UserSetSocConfirm) o;
