...
public class VehicleInfoConfirm implements Validatable {

    private static final Logger logger = LoggerFactory.getLogger(VehicleInfoConfirm.class);
    ...
    public boolean equals(Object o) {
        ...
        VehicleInfoConfirm that = (VehicleInfoConfirm) o;
