...
public class ChangeModeData implements Validatable {

    private int connectorId;    // Connector ID
    private int rechgAmt;       // 충전SOC
    private int rechgElec;      // 충전전력
    private int HH00;
    private int HH01;
    private int HH02;
    private int HH03;
    ...
    public int getRechgElec() {
        return rechgElec;
    }

    public void setRechgElec(int rechgElec) {
        this.rechgElec = rechgElec;
    }
    ...
    public boolean equals(Object o) {
        ...
        ChangeModeData that = (ChangeModeData) o;
        return connectorId == that.connectorId &&
                rechgAmt == that.rechgAmt &&
                rechgElec == that.rechgElec &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(connectorId, rechgAmt, rechgElec,
