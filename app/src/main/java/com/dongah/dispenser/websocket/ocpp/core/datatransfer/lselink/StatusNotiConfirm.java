...
public class StatusNotiConfirm implements Validatable {

    private static final Logger logger = LoggerFactory.getLogger(StatusNotiConfirm.class);
    ...
    public boolean equals(Object o) {
        ...
        StatusNotiConfirm that = (StatusNotiConfirm) o;
