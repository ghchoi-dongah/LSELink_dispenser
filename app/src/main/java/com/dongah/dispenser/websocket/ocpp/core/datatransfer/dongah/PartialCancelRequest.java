package com.dongah.dispenser.websocket.ocpp.core.datatransfer.dongah;
...
public class PartialCancelRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(PartialCancelRequest.class);
    ...
    public boolean equals(Object o) {
        ...
        PartialCancelRequest that = (PartialCancelRequest) o;
