...
public class UnitPriceRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(UnitPriceRequest.class);
    ...
    public boolean equals(Object o) {
        ...
        UnitPriceRequest that = (UnitPriceRequest) o;
