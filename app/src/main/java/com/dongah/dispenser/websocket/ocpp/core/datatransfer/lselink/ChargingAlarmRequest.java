...
public class ChargingAlarmRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(ChargingAlarmRequest.class);
    ...
    public boolean equals(Object o) {
        ...
        ChargingAlarmRequest that = (ChargingAlarmRequest) o;
