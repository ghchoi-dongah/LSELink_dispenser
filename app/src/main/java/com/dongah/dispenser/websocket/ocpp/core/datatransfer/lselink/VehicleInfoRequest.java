...
public class VehicleInfoRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(VehicleInfoRequest.class);
    ...
    public boolean equals(Object o) {
        ...
        VehicleInfoRequest that = (VehicleInfoRequest) o;
