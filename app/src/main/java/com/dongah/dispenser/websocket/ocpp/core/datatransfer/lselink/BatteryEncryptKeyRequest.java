...
import com.dongah.dispenser.websocket.ocpp.utilities.ModelUtil;
...
public class BatteryEncryptKeyRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(BatteryEncryptKeyRequest.class);
    ...
    public BatteryEncryptKeyRequest() {}
    ...
    public boolean equals(Object o) {
        ...
        BatteryEncryptKeyRequest that = (BatteryEncryptKeyRequest) o;
