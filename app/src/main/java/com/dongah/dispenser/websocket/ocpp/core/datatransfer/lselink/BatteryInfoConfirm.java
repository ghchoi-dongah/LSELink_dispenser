...
public class BatteryInfoConfirm implements Validatable {

    private static final Logger logger = LoggerFactory.getLogger(BatteryInfoConfirm.class);
    ...
    public boolean equals(Object o) {
        ...
        BatteryInfoConfirm that = (BatteryInfoConfirm) o;
