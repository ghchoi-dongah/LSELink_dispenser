...
public class ChangeModeRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(ChangeModeRequest.class);
    ...
    public boolean equals(Object o) {
        ...
        ChangeModeRequest that = (ChangeModeRequest) o;
