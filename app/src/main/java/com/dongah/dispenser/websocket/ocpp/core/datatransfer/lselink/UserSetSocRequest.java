...
public class UserSetSocRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(UserSetSocRequest.class);
    ...
    public boolean equals(Object o) {
        ...
        UserSetSocRequest that = (UserSetSocRequest) o;
