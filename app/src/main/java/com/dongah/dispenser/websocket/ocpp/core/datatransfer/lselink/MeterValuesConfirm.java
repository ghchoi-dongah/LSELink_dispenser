...
public class MeterValuesConfirm implements Validatable {

    private static final Logger logger = LoggerFactory.getLogger(MeterValuesConfirm.class);
    ...
    public boolean equals(Object o) {
        ...
        MeterValuesConfirm that = (MeterValuesConfirm) o;
